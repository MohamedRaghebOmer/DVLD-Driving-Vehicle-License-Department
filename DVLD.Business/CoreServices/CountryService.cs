    ...
    public static class CountryService
    {
        public static Country Save(Country country)
        {
            ...
            if (country.CountryID == -1)
            {
                ...
                try
                {
                    return (CountryRepository.Add(country) != -1) ? CountryRepository.Get(country.CountryID) : null;
                }
                catch (Exception ex)
                {
            ...
            else // Update existing country
            {
                ...
                try
                {
                    return (CountryRepository.Update(country)) ? CountryRepository.Get(country.CountryID) : null;
                }
                catch (Exception ex)
                {
        ...
        public static int GetIdByName(string countryName)
        {
            ...
            try
            {
                return CountryRepository.GetIdByName(countryName);
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetAllNames()
        {
            try
            {
                return CountryRepository.GetAllNames();
            }
            catch (Exception ex)
            {
        ...
        public static bool Delete(string countryName)
        {
            ...
            try
            {
                return CountryRepository.Delete(countryName);
            }
            catch (Exception ex)
            {
